# Funnel 01 — Full Delivery System V5 — Canonical Founder-Directed Architecture

Status: CURRENT FOUNDER-DIRECTED DELIVERY ARCHITECTURE — supersedes V4; exact medical/scientific wording, procedures, statistics and data slides require Dott.ssa Mafalda Camposarcone review before customer use
Date: 2026-09-22

Purpose: consolidate the current founder decisions for the rebuilt Formalife Full Course into one live-event architecture, preserving current ERC/IRC/AHA evidence boundaries, attention management, deliberate practice, customer experience and Funnel 01 continuity.

This file supersedes `FUNNEL_01_FULL_DELIVERY_SYSTEM_V4_FOUNDER_DIRECTED.md` as the active delivery architecture. V1–V4 remain historical research/provenance.

Commercial architecture remains:

**choking/weaning trigger -> broader parent-first preparedness system -> BEFORE -> LIVE -> AFTER / HOME REFERENCE + REFRESH.**
...
1. **No long passive lecture.** Alternate explanation, visual demonstration, questions, physical practice, feedback and retrieval.
2. **Do not confuse breadth with learning.** A topic that cannot be taught responsibly in the available time moves to reference/post-course rather than being rushed.
...
# 3. ACT 0 — Open + Test Esperienziale Iniziale

Working duration: ~12 min.

## 3.1 Short human introduction
...
## 3.2 Rapid participant calibration

Approximately 3 minutes with quick hands/short answers:

- age range of child/children;
- complementary feeding / current feeding stage where relevant;
- prior choking/first-aid training;
- what brought the participant here.

Purpose:

- human integration;
- calibrate examples/emphasis;
- collect live market evidence without turning opening into twelve individual interviews.

## 3.3 Experiential baseline — signature mechanic

Approximately 7 minutes.

Use one consenting volunteer and a safe manikin/trainer/neutral simulation object for any physical action.

Baseline example:

1. child is eating;
2. initially cough is effective/audible;
3. situation progresses to ineffective/absent cough and little/no effective airflow;
4. volunteer reacts without coaching for a short safe window;
5. facilitator stops scenario;
6. volunteer/room briefly describe what they noticed and why they reacted that way.

Explicit framing:

**this is not an exam and the volunteer is not being humiliated; it is a photograph of the room's starting point.**
...
# 13. Attention choreography

Apply throughout:

- no prolonged passive monologue;
- change learner mode regularly;
- use visual contrast, demonstration, practice, correction and retrieval;
...
- do not claim a universal 10–15 minute biological attention limit;
- use active attention choreography instead;
